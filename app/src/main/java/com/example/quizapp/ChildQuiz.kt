...
class ChildQuiz : AppCompatActivity(), View.OnClickListener
{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mUserName = intent.getStringExtra(Constants3.USER_NAME)
            ...
            R.id.btn_submit ->{
                ...
                if(mSelectedOptionPosition ==0){
                    ...
                    when{
                        ...
                        intent.putExtra(Constants3.USER_NAME,mUserName)
